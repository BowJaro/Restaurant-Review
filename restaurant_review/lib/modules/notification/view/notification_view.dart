...
class NotificationView extends GetView<NotificationController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text(FlutterI18n.translate(context, "notification.notification")),
        centerTitle: true,
      ),
      body: Obx(() {
              ...
              return Dismissible(
                ...
                confirmDismiss: (direction) {
                  return Get.defaultDialog(
                    ...
                    textCancel: FlutterI18n.translate(context, "modal.cancel"),
                    onConfirm: () {
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    leading: controller.notificationList[index].imageUrl == null
                        ? const CircleAvatar(
                            radius: 30,
